...
using marketboard.Client.Infrastructure.Authentication;
using marketboard.Client.Infrastructure.Managers;
using marketboard.Client.Infrastructure.Managers.Preferences;
...
using marketboard.Client.Infrastructure.Managers.ExtendedAttribute;
using marketboard.Domain.Entities.ExtendedAttributes;
using marketboard.Domain.Entities.Misc;
using Toolbelt.Blazor.Extensions.DependencyInjection;

namespace marketboard.Client.Extensions
{
