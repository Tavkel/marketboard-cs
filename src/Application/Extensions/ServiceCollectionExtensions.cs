...
using marketboard.Application.Features.ExtendedAttributes.Commands.Delete;
...
using marketboard.Application.Features.ExtendedAttributes.Queries.GetById;
using marketboard.Domain.Contracts;
using marketboard.Shared.Wrapper;

namespace marketboard.Application.Extensions
{
    public static class ServiceCollectionExtensions
    {
        public static void AddApplicationLayer(this IServiceCollection services)
        {
            ...
            MediatRServiceConfiguration mediatRServiceConfiguration = new();
