...
using marketboard.Client.Extensions;
using marketboard.Client.Infrastructure.Mappings;
using marketboard.Shared.Constants.Application;
using Microsoft.AspNetCore.Components;
using Microsoft.AspNetCore.SignalR.Client;
using MudBlazor;
using System.Threading.Tasks;
using marketboard.Client.Infrastructure.Managers.Identity.Roles;
using marketboard.Shared.Constants.Permission;
using Microsoft.AspNetCore.Authorization;

namespace marketboard.Client.Pages.Identity
{
