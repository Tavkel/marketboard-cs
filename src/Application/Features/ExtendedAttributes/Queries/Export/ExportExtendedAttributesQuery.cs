...
using marketboard.Application.Interfaces.Repositories;
using marketboard.Application.Interfaces.Services;
using marketboard.Application.Specifications.ExtendedAttribute;
using marketboard.Domain.Contracts;
using marketboard.Domain.Enums;
using marketboard.Shared.Wrapper;
using MediatR;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Localization;

namespace marketboard.Application.Features.ExtendedAttributes.Queries.Export
{
