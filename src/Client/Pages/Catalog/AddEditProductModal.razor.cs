...
using marketboard.Client.Infrastructure.Managers.Catalog.Brand;
using marketboard.Client.Infrastructure.Managers.Catalog.Product;

namespace marketboard.Client.Pages.Catalog
{
